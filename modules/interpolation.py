...
def create_interpolation_surface(year, method, variogram_model, gdf_filtered_map, df_anual_non_na):
    """
    Genera la superficie de interpolación y el variograma (si aplica).
    Soporta Kriging Ordinario, Kriging con Deriva Externa, IDW y Spline.
    """
    ...
    try:
        if method in ["Kriging Ordinario", "Kriging con Deriva Externa (KED)"]:
            ...
            else: # Kriging con Deriva Externa (KED)
